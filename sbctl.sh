...
readonly SING_BOX_MIN_VERSION="1.12.0"

SING_BOX_RELEASE_INSTALL_PATH="${SBCTL_SING_BOX_RELEASE_INSTALL_PATH:-/usr/local/bin/sing-box}"
SING_BOX_RELEASE_API="${SBCTL_SING_BOX_RELEASE_API:-https://api.github.com/repos/SagerNet/sing-box/releases/latest}"
SING_BOX_RELEASE_DOWNLOAD_BASE="${SBCTL_SING_BOX_RELEASE_DOWNLOAD_BASE:-https://github.com/SagerNet/sing-box/releases/download}"

SING_BOX_BIN="${SBCTL_SING_BOX_BIN:-$SING_BOX_RELEASE_INSTALL_PATH}"
