...
for _module in core ui engine compat inbound certificate reality outbound clients share ops management menu protocols layout hy2_hop hy2_create hy2_nft hy2_interval; do
